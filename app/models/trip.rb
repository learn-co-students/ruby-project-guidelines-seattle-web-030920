class Trip < ActiveRecord::Base
    ...
    def to_s
        ...
        str_build2 = " |mnfct: #{bike_man.ljust(10)} |source: #{self.start_city.ljust(20)} |dest: #{self.dest_city.ljust(20)}" 
        str_build3 = " |dst_miles: #{self.distance_miles.round(2).to_s.ljust(6)} |strt_date: #{self.start_date.to_s.ljust(6)} |end_date: #{self.end_date}"
